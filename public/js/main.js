function añadirTec(tipo) {
    ...
    if (tipo == 'tecnico'){
        $('#tecnicoDatos').append(
            ...
            '<select name="especializacion" id="especializacion" class="form-control"><option value="" disabled selected>Especialización</option><option value="pinchazo">Pinchazo</option><option value="motor">Motor</option><option value="golpe">Golpe</option><option value="bateria">Batería</option><option value="otros">Otros</option></select><br>'+
            ...
            '<select name="comunidad" id="comunidad" class="form-control"><option value="" disabled selected>Comunidad</option><option value="alava">Álava/Araba</option><option value="vizcaya">Vizcaya/Bizkaia</option><option value="guipuzcoa">Guipúzcoa/Gipuzkoa</option></select><br>'
        )
    }else{
