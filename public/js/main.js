function añadirTec(tipo) {
    ...
    if (tipo == 'tecnico'){
        $('#tecnicoDatos').append(
            ...
            '<select name="comunidad" class="custom-select"><option disabled selected>Comunidad</option><option value="alava">Alava/Araba</option><option value="Vizcaya">Vizcaya/Bizkaia</option><option value="guipuzcoa">Guipúzcoa/Gipuzkoa</option></select>'
        )
    }else{
