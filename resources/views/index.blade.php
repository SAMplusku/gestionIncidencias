    ...
    <div class="index d-flex justify-content-center" style="margin-bottom: 40px">
        ...
        @if(isset($_SESSION['nombre']))
            @if($_SESSION['persona'] == "tecnico")
                    <div class="col-md-12">
                        <div class="jumbotron p-3">
                            <div class="d-flex justify-content-center"><img src="https://estaticos.elperiodico.com/resources/jpg/3/8/fcasals25757716-madrid-autopista-radial-foto-jose-luis-roc161213172509-1481646513783.jpg" style="width: 9em; height: 9em;"class="card-img-top d-flex justify-content-center" alt="..."></div><br>
                            <h1 class="d-flex justify-content-center"><a href="/perfil/{{$_SESSION['id']}}">Ver mis incidencias</a></h1>
                        </div>
                    </div>
            @endif
            ...
            @if($_SESSION['persona'] == "coordinador" || $_SESSION['persona'] == 'gerente')
                <div class="col-md-6">
                    <div class="jumbotron p-3">
                        <div class="d-flex justify-content-center"><img src="https://eduliticas.com/wp-content/uploads/2015/07/diagrama-de-sectores.png" style="width: 9em; height: 9em;"class="card-img-top d-flex justify-content-center" alt="..."></div><br>
            ...
            @if($_SESSION['persona'] == "coordinador" || $_SESSION['persona'] == 'gerente')
                <div class="col-md-6">
                    <div class="jumbotron p-3">
                        <div class="d-flex justify-content-center"><img src="https://image.freepik.com/foto-gratis/hombre-mujer-trajes-negocios-estrictos-oficina_85574-2043.jpg" style="width: 9em; height: 9em;"class="card-img-top d-flex justify-content-center" alt="..."></div><br>
                        <h1 class="d-flex justify-content-center"><a href="/register">Alta usuario</a></h1>
                    </div>
                </div>
            @endif
        @endif
