...
@section("content")
    ...
    <div class="container-fluid p-2">
        <div class="col-sm-11">
            <h1 class="h2 mb-3 font-weight-normal p-0 m-0 text-center" >Incidencia - 30</h1>
        ...
        <form class="form " action="" method="post">
            <div class="float-right col-xs-12 col-sm-6 w-50">
                ...
                <div class="form-group ">
                    <div class="col-xs-6">
                        <h5>Observaciones</h5>
                        <textarea class="form-control" type="text" name="observacion" placeholder="Observaciones"  required>{{$incidencia->observacion}}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xs-6">
                        <h5>Tecnico</h5>
                        <input type="text" class="form-control" name="id_tecnico" value="{{$incidencia->id_tecnico}}">
                    </div>
                </div>
                ...
                <div class="form-group ">
                    <div class="col-xs-6">
                        <h5>Operador</h5>
                        <input type="text" class="form-control" name="id_operador" value="{{$incidencia->id_operador}}">
                    </div>
                </div>
...
>>>>>>> c5755e7ecb5ca49f7bcb1148531182c5a01d7236
            ...
            @else
                ...
                <div class="form-group ">
                    <div class="col-xs-6">
                        <h5>Descripcion</h5>
                        <textarea disabled class="form-control" type="text" name="descripcion" required>{{$incidencia->descripcion}}</textarea>
                    </div>
                </div>
                <div class="form-group ">
                    <div class="col-xs-6">
                        <h5>Observaciones</h5>
                        <textarea disabled class="form-control" type="text" name="observacion" placeholder="Observaciones"  required>{{$incidencia->observacion}}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xs-6">
                        <h5>Tecnico</h5>
                        <input type="text" class="form-control" disabled name="id_tecnico" value="{{$incidencia->id_tecnico}}">
                    </div>
                </div>
                ...
                <div class="form-group ">
                    <div class="col-xs-6">
                        <h5>Operador</h5>
                        <input type="text" class="form-control" disabled name="id_operador" value="{{$incidencia->id_operador}}">
                    </div>
                </div>
                </div>
                ...
                <div class="form-group col-sm-6">
                    <div class="col-xs-6">
                        <h5>Nombre</h5>
                        <input type="text" class="form-control" disabled name="nombre"  value="{{$cliente->nombre}}">
                    </div>
                </div>
                ...
                <div class="form-group col-sm-6">
                    <div class="col-xs-6">
                        <h5>Apellidos</h5>
                        <input type="text" class="form-control" disabled name="apellidos"  value="{{$cliente->apellidos}}">
                    </div>
                </div>
                ...
                <div class="form-group col-sm-6">
                    <div class="col-xs-6">
                        <h5>Telefono</h5>
                        <input type="text" class="form-control" disabled name="telefono"  value="{{$cliente->telefono}}">
                    </div>
                </div>
                ...
                <div class="form-group col-sm-6">
                    <div class="col-xs-6">
                        <label for="email"><h5>Email</h5></label>
                        <input type="email" class="form-control" disabled name="email"  value="{{$cliente->email}}" >
                    </div>
                </div>
                ...
                <div class="form-group col-sm-6">
                    <div class="col-xs-6">
                        <h5>Direccion</h5>
                        <input type="text" class="form-control" disabled name="direccion"  value="{{$cliente->direccion}}">
                    </div>
                </div>
                ...
                <div class="form-group col-sm-6">
                    <div class="col-xs-6">
                        <h5>Fecha de nacimiento</h5>
                        <input type="text" class="form-control" disabled name="fecha" value="{{$cliente->edad}}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="form-group col-sm-6">
                        <h5>Matricula</h5>
                        <input class="form-control" type="text" disabled name="matricula" value="{{$vehiculo->matricula}}" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="form-group col-sm-6">
                        <h5>Marca</h5>
                        <input class="form-control" type="text" disabled name="marca" value="{{$vehiculo->marca}}" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="form-group col-sm-6">
                        <h5>Modelo</h5>
                        <input class="form-control" type="text" disabled name="modelo" value="{{$vehiculo->modelo}}" required>
                    </div>
                </div>
